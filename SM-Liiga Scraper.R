# SM-Liiga Scraper
# Scraper used to scrape box scores for the Finnish Hockey League (SM-Liiga)
# Author = Jameel Kaba
...
# Get the links to get box scores for each game in a season 
...
# Get the links for seasons starting from 2014-15 and going till current 2019-2020 
schedule <- map_df(c("2014-2015", "2015-2016", "2016-2017", "2017-2018", "2018-2019", "2019-2020"), get_schedule)
...
# Attempts to get the box score, returns an error otherwise
...
# Store the box score info for each game of each season
